...
public class Main {
    public static void main(String[] args) {
        ...
        if (nrStandard > 0)
            System.out.printf(String.format(Locale.US,"STANDARD: suma = %.2f lei, numar = %d\n", sumaStandard, nrStandard));
        if (nrDiscounted > 0)
            System.out.printf(String.format(Locale.US,"DISCOUNTED: suma = %.2f lei, numar = %d\n", sumaDiscounted, nrDiscounted));
        if (nrGift > 0)
            System.out.printf(String.format(Locale.US, "GIFT: suma = 0.00 lei, numar = %d\n", nrGift));
        System.out.printf(String.format(Locale.US, "Total platit: %.2f lei\n", sumaStandard + sumaDiscounted));
    }
}
